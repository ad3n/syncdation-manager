...
{
    public function __construct(private NodeService $service, private SerializerInterface $serializer)
    {
    }

    /**
     * @Route("/nodes/download", name=Download::class, methods={"GET"})
     */
    public function __invoke(): Response
    {
        ...
        $response->headers->set('Content-Disposition', sprintf('attachment; filename="%s_%s.csv"', 'nodes', date('YmdHis')));

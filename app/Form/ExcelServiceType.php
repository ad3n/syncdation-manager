 ...
 */
final class ExcelServiceType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('prefixName', null, [
            'required' => false,
            'label' => 'sas.form.field.service.prefixName',
        ]);
        $builder->add('rotation', null, [
            'required' => false,
            'label' => 'sas.form.field.service.rotation',
        ]);

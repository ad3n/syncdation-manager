 ...
 */
final class FilterRequestByLoggedUserExtension extends AbstractQueryExtension
{
    ...
    {
        return in_array(ApiClientRequestInterface::class, class_implements($class)) && str_contains($request->getPathInfo(), '/me/');
    }
}
